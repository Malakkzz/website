...
?>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="me-md-3 pt-3 w-100 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-5 py-5" style="color:#198754;border-radius:10px;">
        <h1>Welcome to UTDC!<br>Where everything is free</h1><br><a class="btn btn-success my-4" href="signup.php">Sign up</a>
      </div>
    </div>
  ...
  <hr class="my-5 text-success container">
